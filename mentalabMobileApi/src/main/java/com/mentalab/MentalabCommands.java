...
enum SamplingRate {
            ...
            try {
                ...
                if (mmSocket != null) {
                    try {
                        ...
                        Log.d(TAG, "mmSocket.close()  failed after failed connection with message:" + e.getMessage());
   ...
   /* *//**
     ...
     *
     * Sampling rate only applies to ExG data. Orientation
     * and Environment data are always sampled at 20Hz.
     * Currently available sampling rates are
     * 250,500 and 1000 Hz. Default is 250Hz.
     *
    ...
    *//**
     ...
     *
     * By default data from all modules is collected.
     * Disable modules you do not need to save bandwidth and power.
     * Calling setEnabled with a partial map is supported.
     * Trying to enable a channel that the device does not have
     * results in a CommandFailedException thrown.
     * When a CommandFailedException is received from this method,
     * none or only some of the switches may have been set.
     *
     * @param switches Map of modules to on (true) or off (false) state
     *                 accelerometer, magnetometer, gyroscope,
     *                 environment, channel0 .. 31
    ...
    *//**
     ...
     *
     * Defaults: 250Hz sampling rate, data collection
     * from all modules is enabled.
     *
     * @throws CommandFailedException
     * @throws NoConnectionException
     * @throws NoBluetoothException
